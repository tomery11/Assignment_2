...
public class GeometryTester {
    ...
    public boolean testPoint() {
        ...
        //System.out.println("Test distance test: " + p1.distance(p2));
        if (p1.distance(p2) != 5) {
            System.out.println("Test distance failed." + p1.distance(p2));
            mistake = true;
        }
        if (!p1.equals(p1)) {
    ...
    public boolean testLine() {
        ...
        Line l4 = new Line(11, -2, 13, 1);
/*
        System.out.println("gradient of L1 is: " + l1.gradient());
        System.out.println("y axis of L1 is: " + l1.y_axis());
        Point p = l1.calcIntersection(l2);
        System.out.println("intersection point of L1 & L2 is: (" + p.getX() + "," + p.getY() + ")");
*/
